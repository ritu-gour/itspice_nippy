    ...
    <div class="container my-5">
        ...
        <div class="row">
            ...
            <div class="col-sm-6 my-">
                <img src="nippyimage/login.jpg" class="signupimag" />
            </div>
            <div class="col-sm-6">
                <div class="card111">
                    <br><br>
                    ...
                    ?>
                        <div class="mb-4">
                            ...
                            <input class="form-control control11" type="email" name="email" placeholder="Email Address" maxlength="20"
                        ...
                        <div class="link login-link text-center">Not yet a member? <a href="signup.php">Signup
                                now</a></div>
                    </form>
                </div>
            </div>
