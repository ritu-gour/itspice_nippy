...
if(isset($_POST['submit_form'])){
    ...
    if(count($errors) === 0){
        ...
        $insert_data = "INSERT INTO usercontacts (name, email, subjt, msg)
            ...
            <div class="col-sm-6">
                <div class="d-inline-flex">
                    ...
                    <div class="p-2 ">
                        ...
                        <p class="cd1">1 gha 35 dadabari kota Rajasthan 324009
                        </p>
                    </div>
                ...
                <div class="d-inline-flex">
                    ...
                    <div class="p-2 ">
                        ...
                        <p class="cd1">santosh.mahajan@nippyinfotech.in<br>
                            akshay.mantri@nippyinfotech.in</p>
                    </div>
                ...
                <div class="d-inline-flex">
                    ...
                    <div class="p-2 ">
                        <h4 class="cs">Call</h4>
                        <a href="tel:7366953335" class="cd">8290411176
                        </a>
                ...
                <iframe
                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3611.432266238308!2d75.83090407516204!3d25.154878077738317!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x396f84c8f0d9829f%3A0xdcab79465c078057!2s35%2F1BHA%2C%20Dadabari%20Extension%2C%20Dadabari%2C%20Kota%2C%20Rajasthan%20324009!5e0!3m2!1sen!2sin!4v1705924844905!5m2!1sen!2sin"
                ...
                <div class="card111">
                    ...
                    <form action="" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="name" class="form-control control11" placeholder="Your Name" maxlength="20"
                                required>

                        </div>
                        <div class="mb-4">

                            <input type="email" name="email" class="form-control control11" placeholder="Your Email" maxlength="20"
                                required>
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="msg" id="" cols="30" rows="5" class="form-control control11" maxlength="60"
