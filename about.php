...
<body>
    ...
    <div class="container bnm">
        <div class="row">
            ...
            <div class="col-sm-6 my-5">
                <h1 class="nippy1 mb-3">About Us</h1>
                <h4>
                    Digital Solution With 10 Years Of Experience
                </h4>
                <p class="j3">
                    He believes that in today’s digital world, successful organizations are the ones, which have the
                    ability to convert consumers’ aspirations into instant gratification.</p>
            ...
            <div class="col-sm-5 my-4">
                ...
                <img src="nippyimage/feature.jpg" class="fludi" />
            </div>
        </div>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-lg-6 mb-4" data-aos="fade-up" data-aos-duration="3000">
                    <div class="grid-item">
                        <img src="nippyimage/target.png" alt="Campus Image 1" class="img-fluid" style="">
                        <div class="caption my-3">
                            <h3>OUR MISSION
                            </h3>
                            <p class="p1">Our mission is elegantly simple to guide and support you on your digital
                                journey, from its very inception to the pinnacle of excellence. We strive to empower our
                                clients to enhance their online presence, engage meaningfully with their target
                                audiences, and transform their digital aspirations into vibrant realities.
                            </p>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 col-lg-6 mb-4" data-aos="fade-up" data-aos-duration="3000">
                    <div class="grid-item">
                        <img src="nippyimage/OUR VISION1.png" alt="Campus Image 2" class="img-fluid">
                        <div class="caption my-3">
                            <h3>OUR VISION</h3>
                            <p class="p1 ">Our strategy is grounded in our understanding of the digital realm's
                                intricate nuances. We leverage our diverse range of services, encompassing SEO, social
                                media marketing, web development, PPC, and more, to tailor solutions that align
                                perfectly with your unique goals. Our strategy is not merely about achieving digital
                                greatness; it's about crafting a transformative digital journey that leaves an indelible
                                mark.</p>
                        </div>
                    </div>
                </div>
    ...
    <section class=" content-section1 my-5">
        <div class="container">
    ...
    <div class="container bnm">
        <div class="row">
            ...
            <div class="col-sm-6 my-5">
                <h1 class="nippy1">Explore Our Expertise
                </h1>

                <p class="j3">
                    Our services are designed to drive results, and we're committed to partnering with you to achieve
                    digital success. Whether you're looking to boost your online visibility, engage with your target
                    audience, or develop a dynamic web presence, Orphic Solution has the expertise and experience to
                    make it happen.

                    Explore our services and let's embark on a journey to digital excellence together

                    Join us on this remarkable voyage, where the date of our establishment serves as a constant reminder
                    of our dedication to shaping a digital future filled with innovation and success. Your
                    transformative journey begins here, with us, at Nippy Technology</p>
            ...
            <div class="col-sm-5 my-4">
                ...
                <img src="nippyimage/Programmers-engrossed-in-deep-collaboration-800x419.webp" class="fludi" />
            </div>
        </div>
