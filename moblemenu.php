...
<head>
 ...
 -->
    ...
    <link rel="icon" type="image/x-icon" href="nippylogo.png.png">
...
<body>
    ...
    <div class="desktop1 bg-light fixed-top shadow-lg">
        ...
        <header class="">
            ...
            <a href="" class="logo"><img src="nippylogo.png" height="70px" width="150px"
                    style=" padding: 3px 0px 3px 0px ; margin:0px 0px 0px -30px;"></a>
                ...
                <ul class="navigation">
                    ...
                    <nav class="navbar">
                        ...
                        <div class="navbar-nav w-100">
                            ...
                            <li class="li90"><a href="services.php" title="Home">Services</a></li>
